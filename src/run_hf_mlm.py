...
"""
# copied from original HF transformers
...
class DataTrainingArguments:
    ...
    tensorboard_log_dir: Optional[str] = field(
        default=None, metadata={"help": "Directory where to save Tensorboard logs"}
    )
...
def main():
    ...
    if data_args.tensorboard_log_dir is not None:
        ...
        tb_writer = SummaryWriter(data_args.tensorboard_log_dir)
